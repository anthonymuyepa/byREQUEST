...
Sub StartDoc()
    ...
    fout.WriteLine "Period     Account No ID   Name                   Type      Description                     LastPaid   Due Date   Days DQ      Balance    Code"
...
Sub ProcessLine()
    ...
    If IsNumeric(Left(Trim(srec), 1)) Then
		...
		Dim sOut, sFirst13, sRest

		sFirst13 = Left(srec, 13)
		sRest = Mid(srec, 14)

		sFirst13 = Replace(sFirst13, "-", " ")
		sOut = sFirst13 & sRest
