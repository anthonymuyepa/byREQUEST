...
Sub StartDoc()
    ...
    fout.WriteLine Pad("ExceptionType", 17) & _
                   Pad("Count", 17) & _
                   Pad("Matched", 20) & _
                   Pad("External", 24) & _
                   Pad("Amount", 17)
    ...
    Else
        Do While Not rsSum.EOF
            fout.WriteLine _
                Pad(rsSum("ExceptionType"), 17) & _
                Pad(rsSum("ExceptionCount"), 17) & _
                Pad(rsSum("MatchedToACHList"), 20) & _
                Pad(rsSum("NotFoundInACHList"), 24) & _
                Pad(FormatAmount(rsSum("ExceptionAmount")), 17)
...
Sub WriteExceptionRow(ByRef rs, ByVal includeACH)
    ...
    line = _
        Pad(rs("ExceptionType"), 12) & _
        Pad(FmtDate8(rs("RptDate")), 12) & _
        Pad(rs("RptTime"), 10) & _
        Pad(rs("RptSeq"), 12) & _
        Pad(rs("Acct"), 14) & _
        Pad(rs("SLX"), 6) & _
